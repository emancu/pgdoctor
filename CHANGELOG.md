...
- **`table-vacuum-health`**: new `autovacuum_disabled_exclude` config key stops `autovacuum-disabled` from reporting tables whose names start with the given prefixes ([#100](https://github.com/emancu/pgdoctor/pull/100)).
