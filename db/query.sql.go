...
type XminHorizonBlockersRow struct {
	...
	Object             pgtype.Text
	PinKind            pgtype.Text
	PinnedXid          pgtype.Text
	PinnedXidAge       pgtype.Int8
	HorizonScope       pgtype.Text
	DurationSeconds    pgtype.Int8
	DurationEstimated  pgtype.Bool
	PrivilegeMasked    pgtype.Bool
	Inactive           pgtype.Bool
	Details            pgtype.Text
	MaxSlotWalKeepSize pgtype.Text
}
